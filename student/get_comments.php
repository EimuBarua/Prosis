...
function getMentions($content)
{
    ...
    $str="SELECT * FROM (SELECT * FROM comments WHERE ondate='".$date."' AND post_group_id=".$grpId." ) AS T INNER JOIN students ON T.post_user_id=students.id ORDER BY T.post_date DESC;";
    // echo $str;
